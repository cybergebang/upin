...
def bug2():
	...
	if mail=="":
		...
		print ("====================================================")
		print ("\033[1;92m1.hacked.by.IDCODE@gmail.com")
		print ("\033[1;95m==================================")
		print ("\033[1;93m2.anonymouscirebon@gmail.com")
		print ("\033[1;95m==================================")
		jalan ("")
		time.sleep(2)
		input("[KEMBALI] ")
...
def menu():
	...
	if nu=="":
		...
		os.system("xdg-open https://docs.google.com/document/d/1QAvoVd5NgMbKmTxiPifQe7izuF5heHnwbjxKJ9Umy60/edit?usp=drivesdk/file")
		time.sleep(1)
		menu()
	elif nu=="3" or nu=="03":
		bug2()
...
def login():
	...
	if passw=="":
		...
		time.sleep(4)
		login()
	if usr=="sippitt" and passw=="isal2018":
